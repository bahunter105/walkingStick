...
ActiveRecord::Schema.define(version: 2021_12_17_141345) do
  ...
  create_table "completed_landmarks", force: :cascade do |t|
    t.bigint "landmark_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["landmark_id"], name: "index_completed_landmarks_on_landmark_id"
    t.index ["user_id"], name: "index_completed_landmarks_on_user_id"
  end
  ...
  add_foreign_key "completed_landmarks", "landmarks"
  add_foreign_key "completed_landmarks", "users"
